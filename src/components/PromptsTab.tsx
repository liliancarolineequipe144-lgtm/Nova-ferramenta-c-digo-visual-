                  ...
                  <div className="p-12 flex flex-col flex-grow bg-gradient-to-br from-white to-slate-50/50">
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-10">
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        >
                          <Heart size={18} fill={isFavorite(prompt.id) ? "currentColor" : "none"} className="group-hover/fav:scale-110 transition-transform" />
                        </button>
                        <button 
                          onClick={() => copyToClipboard(prompt.content, prompt.id)}
                          className={`flex items-center gap-2.5 px-5 py-3 rounded-xl font-black text-[10px] transition-all duration-500 shadow-sm active:scale-95 shrink-0 uppercase tracking-widest group/copy ${
                            copiedId === prompt.id 
                        ...
                        >
                          {copiedId === prompt.id ? (
                            ...
                            <><Copy size={14} strokeWidth={3} className="group-hover/copy:scale-110 transition-transform" /> Copiar Prompt</>
                          )}
                        </button>
                      </div>
                    </div>
